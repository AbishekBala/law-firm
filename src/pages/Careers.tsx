      ...
      <section className="section-padding bg-neutral-50">
        <div className="container-max">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-neutral-600 max-w-2xl mx-auto">
              We offer a complete benefits package designed to support your professional and personal well-being.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-lg font-semibold text-legal-navy mb-4">Health & Wellness</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-lg font-semibold text-legal-navy mb-4">Professional Development</h3>
              <ul className="space-y-2 text-neutral-600">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-accent rounded-full mr-3"></div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <h3 className="text-lg font-semibold text-legal-navy mb-4">Work-Life Balance</h3>
              <ul className="space-y-2 text-neutral-600">
                <li className="flex items-center">
                  <div className="w-2 h-2 bg-accent rounded-full mr-3"></div>
